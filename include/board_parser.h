...
#ifdef STM32U585xx
#define BUILD_PLATFORM_NAME "STM32U585"
#ifndef JES_UART_CUSTOM
#define USART_RCC_PERIPH RCC_LPUART1CLKSOURCE_PCLK3;
#define USART_CLK_SRC_DEFAULT(PeriphClkInit_struct) PeriphClkInit_struct.Lpuart1ClockSelection = RCC_LPUART1CLKSOURCE_PCLK3
#define USART_CLK_ENABLE() __HAL_RCC_LPUART1_CLK_ENABLE()
#define USART_CLK_GPIO_ENABLE() __HAL_RCC_GPIOG_CLK_ENABLE()
#define USART_CLK_GPIO_DISABLE() __LPUART1_CLK_DISABLE();
#define USART_NUM LPUART1
#define USART_GPIO_TX_PORT GPIOG
#define USART_GPIO_RX_PORT GPIOG
#define USART_GPIO_TX_NUM GPIO_PIN_7
#define USART_GPIO_RX_NUM GPIO_PIN_8
#define USART_GPIO_TX_ALT GPIO_AF8_LPUART1
#define USART_GPIO_RX_ALT GPIO_AF8_LPUART1
#define USART_IRQn_NUM LPUART1_IRQn
#endif // JES_UART_CUSTOM
#endif // STM32U585xx
