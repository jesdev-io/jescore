...
#ifdef STM32F413xx
#define BUILD_PLATFORM_NAME "STM32LF413"
#ifndef JES_UART_CUSTOM
#define USART_RCC_PERIPH RCC_PERIPHCLK_USART3
#define USART_CLK_SRC_DEFAULT(PeriphClkInit_struct) PeriphClkInit_struct.Usart3ClockSelection = __HAL_RCC_GET_USART3_SOURCE()
...
#define USART_GPIO_TX_NUM GPIO_PIN_9
