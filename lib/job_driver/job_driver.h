...
#define __MAX_JOB_NAME_LEN_BYTE __GET_SAFE_SIZE(MAX_JOB_NAME_LEN_BYTE, __MAX_JOB_NAME_LEN_LIMIT)
#endif
...
#define __MAX_JOB_ARGS_LEN_BYTE __GET_SAFE_SIZE(MAX_JOB_ARGS_LEN_BYTE, __MAX_JOB_ARGS_LEN_LIMIT)
#endif
